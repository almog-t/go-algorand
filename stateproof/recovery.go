...
// GetLowestStateProofRound returns
func GetLowestStateProofRound(latestHeader *bookkeeping.BlockHeader) basics.Round {
	...
	if latestExceptedStateProofRound > oldestRoundOnRecoveryPeriod {
		return latestExceptedStateProofRound
	}
